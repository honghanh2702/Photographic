...
<html>
    <head>
        <meta charset="UTF-8">
  <title>Layout fluide type Masonry en CSS</title>
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/normalize/5.0.0/normalize.min.css">
        <link rel="stylesheet" href="/css/gallery1.css">
        <script src="/script/gallery1.js"></script>
    </head>
    <body>
...
<div class="myGallery">
  <img src="/image/taeyeon.jpg" />
  <img id="image" src="../image/thoi-trang-trong-MV-Four-Seasons-cua-ca-si-Taeyeon-6.jpg" />
...
<!--p><em><small>When you need something more fancy, just check out <a href="https://gridzy.gallery/" target="_blank">Gridzy.Gallery</a></small></em></p-->
    </body>
</html>
