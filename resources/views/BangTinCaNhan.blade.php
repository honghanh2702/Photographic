    ...
    <body class="bg-light" onresize="resizeFunc()">
                        ...
                        <div class="email-list" style="height:400px;">
                            <a href="#"><div class="mr-2 pr-2 radius-10 email-list-item my-1 cursor-pointer"><div class="py-1 list-item-1 mx-3" style="display:block;">
                                ...
                                <div class="my-2 mr-3 notification-img">
                                    <img src="/img/D2bqT3aU4AIGaMd.jfif" alt="D2bqT3aU4AIGaMd.jfif" class="radius-10 cropped" style="width:100%;height:150px;">
                                </div>
                            </div></div></a>
                            <a href="#"><div class="mr-2 pr-2 radius-10 email-list-item my-1 cursor-pointer"><div class="py-1 list-item-1 mx-3" style="display:block;">
                                <span>Bạn có 99 ý tưởng mới đang chờ!</span><br>
            ...
            <div class="dropdown float-left px-0 pt-3 bg-light">
                ...
                <ul class="dropdown-menu dropdown-menu-right radius-10 py-3 bg-light" style="rigth:0;width:350px;">
                    ...
                    <li class="mx-3"><a href="HoTro.html"><div class="radius-10 py-0 list-item-1">
                        <div class="mr-1">
                            <div class="rounded-circle button1"><i class="fa fa-question-circle"></i></div>
                        </div>
                    ...
                    <li class="mx-3"><a href="DieuKhoan.html"><div class="radius-10 py-0 list-item-1">
                        <div class="mr-1">
                            <div class="rounded-circle button1" style="padding-left:9px;padding-top:7px;">
                    ...
                    <li class="mx-3"><a href="DangNhap.html"><div class="radius-10 py-0 list-item-1">
                        <div class="mr-1">
                            <div class="rounded-circle button1"><i class="fas fa-sign-out-alt"></i></div>
                        </div>
                    ...
                    <li class="mx-3"><a href="GioiThieu.html"><div class="radius-10 py-0 list-item-1">
                        <div class="mr-1">
                            <div class="rounded-circle button1"><i class="fas fa-info-circle"></i></div>
                        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="mb-2">
                ...
                <button onclick="window.location.href='ThongTinCaNhan.html'" class="btn btn-light float-left rounded-circle button1" style="margin-top:-6px;"><i class="fas fa-pen"></i></button>
                <!-- Nút Gửi -->
                <div class="dropdown send-dropdown dropright display-inline-flex">
                    <button class="btn rounded-circle float-left btn-light dropdown button1" data-toggle="dropdown" style="margin-top:-6px;">
                ...
                <div class="dropdown dropleft">
                    <button class="btn float-right btn-light rounded-circle button1" data-toggle="dropdown" style="margin-top:-45px;">
                ...
                <!-- Sắp xếp -->
                <div class="dropdown dropleft">
                    <button class="btn float-right btn-light rounded-circle button1"  data-toggle="dropdown" style="margin-top:-45px;margin-right:40px;">
